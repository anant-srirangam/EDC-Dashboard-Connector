...
until curl -s $VAULT_ADDR/v1/sys/health | jq -r '.initialized' >/dev/null 2>&1; do
    sleep 2
done
...
# Step 4: Print token cleanly
echo "✔ Extracted token: $EDC_TOKEN"
