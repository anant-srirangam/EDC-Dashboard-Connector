...
public class DcpPatchExtension implements ServiceExtension {
    public static final String NAME = "DcpPatchExtension";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        trustedIssuerRegistry.register(new Issuer("did:web:host.docker.internal%3A7083", Map.of()), WILDCARD); // for the standard credentials
